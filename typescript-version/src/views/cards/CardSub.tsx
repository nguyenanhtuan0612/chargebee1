...
import { SubPack } from 'src/@core/models/AccountTikTok.model';
...
const CardSub = (props: PropsProduct) => {
    ...
    <Card>
      ...
      <CardContent sx={{ padding: theme => `${theme.spacing(3, 5.25, 4)} !important` }}>
        <Typography sx={{ marginBottom: 2 }}>
          <NumericFormat thousandSeparator prefix='$' value={props.data.price || 0} displayType={'text'} />
        </Typography>
        ...
        <DialogContent sx={[style, { width: { sm: 500 } }]}>
          <Card sx={{ maxWidth: 500 }}>
            <CardContent>
              ...
              <Typography marginBottom={2} variant='body2' color='text.secondary'>
                Xu: <NumericFormat thousandSeparator value={0} displayType={'text'} />
              </Typography>

              <Typography marginBottom={2} variant='body1' color='text.primary' noWrap={true}>
                Giá: <NumericFormat thousandSeparator suffix=' VND' value={0} displayType={'text'} />
              </Typography>
              ...
              <Stack marginTop={3} direction='row' spacing={2} justifyContent='center'>
                <LoadingButton loading={loading} size='small' variant='contained' onClick={e => e.preventDefault()}>
                  Mua ngay
                </LoadingButton>
